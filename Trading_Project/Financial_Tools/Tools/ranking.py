...
class Ranker(object):
    ...
    def ranking_by_moving_average(self,
                                  rolling: int,
                                  best: int
                                  ) -> 'string list':
    ...
    def ranking_by_returns_and_ma(self,
                                  rolling: int,
                                  ranking_periods: int,
                                  best: int,
                                  last: bool = True
        ...
        moving_average = Ranker._moving_average(self, rolling=rolling)
        ranking_by_returns = Ranker.ranking_by_returns(self,
                                                       ranking_periods=ranking_periods,
                                                       last=last,
                                                       best=len(self.prices.columns)
                                                       )
